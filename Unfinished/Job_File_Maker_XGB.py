...
def Get_Global_String_List( time_h, time_m, GPU, mem, model_type, name_suffix_list = ['091824']):
...
# %% Set Global Params
time_h = 1 # hour # BCH - 6, Code15 - 15. Double for 'Any' GPU
time_m = 00 # min

GPU = 'None' # Quadro_RTX or Titan_RTX or Tesla_K or Tesla_T or NVIDIA_A40 or or NVIDIA_A100 'Any' (Any is good for Eval) 
mem = 300 # GB, must be int. MIMICIV has taken at most 249GB so far, Code15 99GB
