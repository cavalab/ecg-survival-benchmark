...
args += ' --Model_Name Ribeiro_MM_1' #InceptionTime or Ribeiro or FFClass
...
args  = '--Train_Folder MIMIC_DEBUG' #MIMICIV_Multimodal_Subset
args += ' --Model_Name Ribeiro_MM_1' #InceptionClass or RibeiroClass or FFClass
