...
mem = 249 # GB, must be int. usually 99 for Code15, or 333 for MIMIC-IV

# %% Set Sweep params

# each element of args_list MUST begin with ' --' (including the space)

Model_Type_List = ['Ribeiro','InceptionTime'] # RibeiroReg, InceptionTimeReg, LSTMReg, TimesNetReg, SpectCNNReg
for Model_Type in Model_Type_List:
    ...
    glob_args_list.append([ ' --GPU_minibatch_limit 64'  ])  # how many to run on GPU at a time. divisor of batch_size. 
